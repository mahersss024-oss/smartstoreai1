...
export const searchWeb = tool({
  description:
    'Search the live web for general current information, company pages, API docs, service regions, documentation, news, manufacturer pages, official store pages, non-food product discovery pages, and facts that may have changed. Do not use for food or grocery product requests. Web result snippets are not confirmed live product data.',
