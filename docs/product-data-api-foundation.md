...
هذه الوثيقة هي الأساس التقني المعتمد لفكرة فصل جلب بيانات المنتجات غير الغذائية عن مشروع الشات.
...
- واجهة الشات.
- فهم طلب العميل.
- حارس النطاق للتأكد أن الطلب داخل التجارة الإلكترونية للمنتجات غير الغذائية فقط.
...
هذا المشروع المستقل يتصل بأي مصدر منتجات مناسب لاحقاً، ثم يرجع بيانات منظمة لمشروع الشات. المواد الغذائية مستبعدة من النتائج.
...
- استبعاد المواد الغذائية من نطاق الشات ومن نتائج المنتجات.
...
- المواد الغذائية والبقالة والمشروبات والوجبات وطلبات المطاعم خارج النطاق.
- يمكن استخدام البحث بالإنترنت كحل مؤقت لاكتشاف صفحات المنتجات غير الغذائية فقط، مع توضيح أن أي سعر ظاهر في نتائج البحث غير مؤكد وقد يتغير.
